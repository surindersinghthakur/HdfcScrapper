...
public class ResearchItem
{
    ...
    /// <summary>"Options" or "Future" for F&amp;O items (null for Stocks). Lets EnrichWithDetails
    /// know which instrument-type dropdown value to select before re-locating this item, since
    /// re-navigating to the research page always defaults back to "Options".</summary>
